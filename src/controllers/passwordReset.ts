...
import { validateInput, initiateSchema, executeSchema } from '../utils/validation';
...
export class PasswordResetController {
  ...
  async initiate(ctx: Context): Promise<void> {
    ...
    const data = validateInput<PasswordResetInitiateRequest>(initiateSchema, body);
  ...
  async execute(ctx: Context): Promise<void> {
    ...
    const data = validateInput<PasswordResetExecuteRequest>(executeSchema, body);
